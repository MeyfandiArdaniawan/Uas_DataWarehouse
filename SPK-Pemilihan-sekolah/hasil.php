...
$W1	= $_POST['Swasta_Negeri'];
$W2	= $_POST['Akreditas_Sekolah'];
$W3	= $_POST['Biaya'];
$W4	= $_POST['Kualitas_Jurusan'];
$W5	= $_POST['Jarak(Km)'];
	...
	<div style="background-color: #efefef">
		<div class="container">
			<div class="section-card" style="padding: 20px 0px">
				...
				<center>
					<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #635c73;">HASIL REKOMENDASI SEKOLAH</h4>
				</center>
				<ul>
					<li>
						<div class="row">
							<div class="card">
								<div class="card-content">
									<h5 style="margin-bottom: 16px; margin-top: -6px;">Matrik Sekolah</h5>
									<table class="responsive-table">
										...
										<tbody>
											...
											while ($data_sekolah=mysqli_fetch_array($query)) {
												$Matrik[$no-1]=array($data_sekolah['Swasta_Negeri_angka'],$data_sekolah['Akreditas_Sekolah_angka'],$data_sekolah['Biaya_angka'],$data_sekolah['Kualitas_Jurusan_angka'],$data_sekolah['Jarak(Km)_angka'] );
												?>
												<tr>
													<td><center><?php echo "A",$no ?></center></td>
													<td><center><?php echo $data_sekolah['Swasta_Negeri_angka'] ?></center></td>
													<td><center><?php echo $data_sekolah['Akreditas_Sekolah_angka'] ?></center></td>
													<td><center><?php echo $data_sekolah['Biaya_angka'] ?></center></td>
													<td><center><?php echo $data_sekolah['Kualitas_Jurusan_angka'] ?></center></td>
													<td><center><?php echo $data_sekolah['Jarak(Km)_angka'] ?></center></td>
												</tr>
												<?php
												$no++;
											}
