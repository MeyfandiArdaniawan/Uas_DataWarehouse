...
<body>
    ...
    <!-- Body Start -->
		...
		<div id="index-banner" class="parallax-container">
			<div class="section no-pad-bot">
				<div class="container">
					...
					<div class="row center">
						<h5 class="header jarak-button col s12 light" style="margin-bottom: 0px; font-size: 26px">PEMILIHAN SEKOLAH</h5>
					</div>
					<div class="row center" \>
			...
			<div class="parallax"><img src="assets/image/scol.jpg" alt="Laptop"></div>
		</div>
		<!-- Jumbotron End -->
		    ...
		    <div class="section-card" style="padding: 36px 0px">
		    	<div class="row">
		    		<div class="col s6">
			    		...
			    		<p style="text-align: justify; padding-right: 16px;">Sistem Pendukung Keputusan Pemilihan Sekolah ini menggunakan metode TOPSIS yang dibangun menggunakan bahasa PHP. Sistem ini dibuat sebagai Tugas Akhir Mata Kuliah Sistem Pendukung Keputusan Prodi Teknik Informatika Universitas Trunojoyo. </p>
						</div>
			    	<div class="col s6">
